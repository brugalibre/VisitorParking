...
class ParkCarServiceIntegTest {
   ...
   void assignParkedCar_NoCardsLeft() {
      ...
      Resident resident = residentService.createResident(facility, User.of("username1"), 0);
   ...
   void assignParkedCarTwice() {
      ...
      // When
      ParkedCarAlreadyAssignedToVisitorParkingCardException thrown = org.junit.jupiter.api.Assertions.
              assertThrows(ParkedCarAlreadyAssignedToVisitorParkingCardException.class,
                      () -> parkCarService.assignParkedCar4PlateNo(resident.getId(), SG_2),
   ...
   void assignParkedCarWithoutValidVisitorParkingCard() {
      ...
      // Given
      User username3 = User.of("username3");
      Facility facility = facilityService.createFacility("Test3", 4);
      Resident resident = residentService.createResident(facility, username3, 1);
