...
public record AssignedParkedCarResult(Resident resident, ParkedCar parkedCar, boolean areNoVisitorParkingCardsLeft,
                                      boolean isParkedCarAlreadyVisitorCardAssigned,
    ...
    */
   public static AssignedParkedCarResult areNoVisitorParkingCardsLeft(Resident resident, ParkedCar parkedCar) {
