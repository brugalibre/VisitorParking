 ...
 */
@Slf4j
public record Resident(String id, Facility facility, User user,
    ...
    */
   public boolean hasParkedCarAssigned(String carPlateNo) {
   ...
   public AssignedParkedCarResult addParkedCarAndAssignVisitorParkingCard(ParkedCar parkedCar) {
      ...
      if (hasParkedCarAssigned(parkedCar.carPlateNo())) {
      ...
      return this.visitorParkingCards
              ...
              .orElseGet(() -> AssignedParkedCarResult.hasNoVisitorParkingCardsLeft(this, parkedCar));
   }
   ...
   private Function<VisitorParkingCard, AssignedParkedCarResult> assignParkedCardAndReturnResult(ParkedCar parkedCar) {
      return visitorParkingCard -> {
         ...
         return createAssignedParkedCarResult(visitorParkingCard, parkedCarWithCardAssigned, parkedCarAdded2FacilityResult.facility());
      };
   }
   ...
   private AssignedParkedCarResult createAssignedParkedCarResult(VisitorParkingCard visitorParkingCard,
                                                                 ParkedCar parkedCar, Facility facility) {
      Resident changedResident = createChangedResident(visitorParkingCard, parkedCar, facility);
      return new AssignedParkedCarResult(changedResident, parkedCar);
   }
   ...
   private Resident createChangedResident(VisitorParkingCard visitorParkingCard, ParkedCar parkedCarWithCardAssigned, Facility changedFacility) {
      return new Resident(this.id, changedFacility, this.user,
